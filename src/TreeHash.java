...
public class TreeHash {
	 ...
	 * File
	 * 
	 * @param args args[0]: a file to compute a SHA-256 tree hash for
	 */
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println(toHex(treeHash));
	 ...
	 * @throws IOException              Thrown if there's an issue reading the input
	 *                                  file
	 ...
	 * @throws IOException              Thrown if there's an IOException when
	 *                                  reading the file
